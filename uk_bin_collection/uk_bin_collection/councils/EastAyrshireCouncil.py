...
class CouncilClass(AbstractGetBinDataClass):
    ...
    def parse_data(self, page: str, **kwargs) -> dict:
        ...
        suggest_url = (
            "https://api.eu.recollect.net/api/areas/EastAyrshireUK/services/waste/address-suggest"
        )
        ...
        events_url = (
            "https://api.eu.recollect.net/api/areas/EastAyrshireUK/services/waste/events"
        )
        params = {
            "nomerge": "1",
            "after": after,
